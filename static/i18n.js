...
(function () {
  ...
  const STR = {
    ...
    "☆ В список": "☆ Watch",
    "★ В списке": "★ Watching",
    "Добавить в список наблюдения": "Add to watchlist",
    "+ Добавить": "+ Add",
    "Тренд: любой": "Trend: any",
    "Тренд: бычий": "Trend: bull",
    "Тренд: медвежий": "Trend: bear",
    "Тренд: флэт": "Trend: flat",
    "Сигнал: любой": "Signal: any",
    "Бычий откат (лонг)": "Bull pullback (long)",
    "Медвежий откат (шорт)": "Bear pullback (short)",
    "Перепродан": "Oversold",
    "Перекуплен": "Overbought",
    "Фильтр по сигналам. Клик по строке открывает полный анализ инструмента.": "Filter by signals. Click a row to open full analysis.",
    "Выберите рынок — данные посчитаются.": "Pick a market — data will be computed.",
    "Считаю сигналы по инструментам…": "Computing signals…",
    "Ничего не подходит под фильтры.": "Nothing matches the filters.",
    "Год": "Year",
    ...
    // — Имбаланс (FVG) —
    "▦ Имбаланс": "▦ Imbalance",
    "Имбаланс (Fair Value Gap) — незаполненные разрывы цены": "Imbalance (Fair Value Gap) — unfilled price gaps",
    "▦ Имбаланс (Fair Value Gap)": "▦ Imbalance (Fair Value Gap)",
    "Незаполненные разрывы цены — рынок часто возвращается их «залить». Кнопка «▦ Имбаланс» над графиком показывает зоны на свечах.":
      "Unfilled price gaps — the market often returns to “fill” them. The “▦ Imbalance” button above the chart shows the zones on candles.",
    "Незаполненных имбалансов рядом нет": "No unfilled imbalances nearby",
    "↑ Бычий": "↑ Bullish",
    "↓ Медвежий": "↓ Bearish",

    // — AI-персоны —
    "🧠 AI-мнения инвесторов": "🧠 AI investor views",
    "Один актив глазами разных стилей · нужен AI-ключ": "One asset through different styles · AI key needed",
