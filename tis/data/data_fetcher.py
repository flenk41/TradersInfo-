...
# Таймаут намеренно небольшой: при гео-блоке/обрыве (РФ без VPN) Binance не должен
# держать запрос десятки секунд — лучше быстро упасть и уйти на Yahoo-фолбэк.
_TIMEOUT = 8
_MAX_RETRIES = 2
_BACKOFF_BASE = 0.4  # сек; растёт экспоненциально: 0.4, 0.8 ...
